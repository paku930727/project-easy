...
} elseif ($_instance->childHasBeenRendered('J7KLWHt')) {
    $componentId = $_instance->getRenderedChildComponentId('J7KLWHt');
    $componentTag = $_instance->getRenderedChildComponentTagName('J7KLWHt');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('J7KLWHt');
} else {
    $response = \Livewire\Livewire::mount('schedule.create', []);
    $html = $response->html();
    $_instance->logRenderedChild('J7KLWHt', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
</script><?php /**PATH /Users/park/Documents/projects/www/resources/views/livewire/schedule/index.blade.php ENDPATH**/ ?>